...
//   const { sidebarOpen, setSidebarOpen, expandedItems, setExpandedItems, activeItem,
//     setActiveItem, activeComponent, setActiveComponent, sidebarWidth, setSidebarWidth,isCollapsed,   
//      setIsCollapsed,    toggleCollapse,    headerComponentRender,    setHeaderComponentRender  } = useContext(ParentContext);
...
import stpllogo1 from '../../assets/stpllogo1.png';
const Sidebar = () => {
  const [isResizing, setIsResizing] = useState(false);
                ...
                <Tooltip>
                  <TooltipTrigger asChild>
                    <Button
                      ...
                      size="sm"
                      onClick={toggleCollapse}
                      className="hidden lg:flex h-8 w-20 p-0 hover:bg-muted/50 transition-colors"
                    >
                      <Menu className="h-4 w-4" />
